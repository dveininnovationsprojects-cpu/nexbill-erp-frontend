...
function SalesAnalytics({ role = "admin" }) {
  ...
  async function fetchDashboardData() {
    ...
    try {
      setLoading(true);
      setErrorMessage("");
      const url = `${API_BASE_URL}?startDate=${encodeURIComponent(dateRange.startDate)}&endDate=${encodeURIComponent(dateRange.endDate)}`;
        ...
        <div className="sal-kpi-grid">
          <div className="sal-kpi">
            ...
            <div>
              ...
              <div className="sal-kpi-sub">Total revenue</div>
            </div>
          </div>
          <div className="sal-kpi">
            ...
            <div>
              ...
              <div className="sal-kpi-sub">Backend net profit</div>
            </div>
          </div>
          <div className="sal-kpi">
            ...
            <div>
              ...
              <div className="sal-kpi-sub">Average invoice value</div>
            </div>
          </div>
          <div className="sal-kpi">
            ...
            <div>
              ...
              <div className="sal-kpi-sub">Discounts given</div>
            </div>
          </div>
        </div>
